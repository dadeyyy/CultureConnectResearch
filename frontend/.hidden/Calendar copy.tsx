...
import { provinces, provincesTest } from "@/lib/provinces";
...
const Calendar = () => {
  ...
  const initialProvince = user.role === "ADMIN" ? getProvinceLabel(user.province) : "Bataan";
  ...
  function getProvinceLabel(value: string): string | undefined {
    const province = provincesTest.find((province) => province.value === value);
    return province ? province.label : undefined;
  }
