                      ...
                      <CardContent className="flex lg:flex-row xs:flex-col items-center justify-center rounded-xl p-0 pr-2 border-2 gap-3">
                        ...
                        <div className="flex flex-col w-1/2">
                          ...
                          <span className="text-base font-base text-justify">
                            Astley himself has been rickrolled a few times; in fact, the first time
                            he was rickrolled actually pre-dated the viral phenomenon. In an
                            interview with Larry King, Astley stated that the first time he fell for
                            the prank was through an email his friend sent him during the early
                            2000s.
                          </span>
                        </div>
                      </CardContent>
