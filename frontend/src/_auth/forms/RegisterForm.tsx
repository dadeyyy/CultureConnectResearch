    ...
    <Form {...form}>
      <div className="sm:w-420 flex-center flex-col">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-1 w-full mt-1">
          <Button type="submit" className="shad-button_primary bg-blue-500 hover:bg-blue-700">
            Create Account
          </Button>

          <div className="flex items-center space-x-2 my-5">
            <p className="text-xs">
              By signing up, you agree to the Terms of Service and Privacy Policy, <br /> including
              Cookie Use.
            </p>
          </div>
